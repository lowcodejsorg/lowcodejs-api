  ...
  @PUT({
    ...
    options: {
      ...
      schema: {
        ...
        description: 'Updates the authenticated user\'s profile information including personal data and optionally password change.',
        security: [{ cookieAuth: [] }],
        body: {
          type: 'object',
          ...
          properties: {
            ...
            allowPasswordChange: {
              type: 'boolean',
              default: false,
              description: 'Enable password change (if true, currentPassword and newPassword are required)'
            },
            currentPassword: {
              type: 'string',
              description: 'Current password (required when allowPasswordChange is true)',
        ...
        response: {
          200: {
            ...
            properties: {
              ...
              email: { type: 'string', format: 'email', description: 'Updated user email' },
